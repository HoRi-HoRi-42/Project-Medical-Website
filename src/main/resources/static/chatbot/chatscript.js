...
function response_message(msg) {
	...
	if(msg=="")
		msg = "Nu inteleg ce spui. Te rog sa reformulezi!";
    INDEX++;
    var str = "";
    if(msg.includes("redirectiona")) {
        var str = "";
        ...
        str += "             <ul>";
        str += "                <li>";
        str += "                    <a href=\"http://localhost:8080/chat\">";
        str += " Chat Doctor";
        str += "                     <\/a>";
        str += "                <\/li>";
        str += "            <\/ul>";
    ...
    else if (msg.includes("programari")){
        var str = "";
        str += "<div id='cm-msg-" + INDEX + "' class=\"chat-msg user\">";
        str += "          <span class=\"msg-avatar\">";
        str += "            <img src=\"/chatbot/robot.svg\">";
        ...
        str += "             <ul>";
        str += "                <li>";
        str += "                    <a href=\"http://localhost:8080/programari\">";
        str += " Programari";
        str += "                     <\/a>";
        str += "                <\/li>";
        str += "            <\/ul>";
